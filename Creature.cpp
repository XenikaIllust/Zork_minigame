...
Creature::Creature(xml_node<>* newCreature) : trigger( (newCreature != nullptr && newCreature->first_node("trigger") != nullptr) ? newCreature->first_node("trigger") : nullptr) {
  if(newCreature != nullptr) {
    ...
    if(newCreature->first_node("attack") != nullptr) {
      xml_node<>* attack_node = newCreature->first_node("attack");

      attack.condition( (attack_node != nullptr && attack_node->first_node("condition") != nullptr ? attack_node->first_node("condition") : nullptr) )
      
      if(attack_node->first_node("action") != nullptr) {
	xml_node<>* action_node = attack_node->first_node("action");
        this->attack.actionlist.push_back(action_node->value());
	...
	while(action_node->next_sibling("action") != nullptr) {
      ...
      if(attack_node->first_node("print") != nullptr) {
	xml_node<>* print_node = attack_node->first_node("print");
        this->attack.printlist.push_back(print_node->value());
